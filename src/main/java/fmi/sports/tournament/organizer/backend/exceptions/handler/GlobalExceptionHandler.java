...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<TournamentResponse> handleNoTournamentWithSuchIdException(
      NoTournamentWithSuchIdException ex) {
  ...
  public ResponseEntity<TeamResponse> handleInappropriateMomentException(
      InappropriateMomentException ex) {
  ...
  public ResponseEntity<TeamResponse> handleTeamAlreadyRegisteredException(
      TeamAlreadyRegisteredException ex) {
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(
            TeamResponse.builder()
  ...
  public ResponseEntity<TeamResponse> handleNoTeamWithSuchIdException(
      NoTeamWithSuchIdException ex) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(
            TeamResponse.builder()
                .responseResult(ResponseResult.ID_NOT_FOUND)
  ...
  public ResponseEntity<TeamResponse> handleNoPlacesAvailableException(
  ...
  public ResponseEntity<TeamResponse> handleNoSufficientMoneyException(
      NoSufficientMoneyException ex) {
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(
            TeamResponse.builder()
  ...
  public ResponseEntity<MatchResponse> handleNoMatchWithSuchIdException(
      NoMatchWithSuchIdException ex) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(
  ...
  public ResponseEntity<MatchResponse> handleTeamNotParticipatingException(
      TeamNotParticipatingException ex) {
  ...
  public ResponseEntity<UserResponse> handleUserAlreadyExistsException(
  ...
  public ResponseEntity<LoginResponse> handleNoUserWithSuchEmailException(
      NoUserWithSuchEmailException ex) {
    return ResponseEntity.badRequest()
        .body(
  ...
  public ResponseEntity<LoginResponse> handleNoUserWithSuchIdException(
      NoUserWithSuchIdException ex) {
    return ResponseEntity.badRequest()
        .body(
            LoginResponse.builder()
                .responseResult(ResponseResult.NOT_EXISTING_USER)
  ...
  public ResponseEntity<LoginResponse> handelIncorrectPasswordException(
  ...
  public ResponseEntity<String> handleInvalidTokenException(InvalidTokenException ex) {
    ex.printStackTrace();
    return ResponseEntity.badRequest().body("Session token is invalid");
  }
  ...
  public ResponseEntity<UserResponse> handleNoParticipantWithIdException(
      NoParticipantWithIdException ex) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(
            UserResponse.builder()
                .responseResult(ResponseResult.ID_NOT_FOUND)
  ...
  public ResponseEntity<TeamResponse> handleUserAlreadyRegisteredForTeamException(
      UserAlreadyRegisteredForTeamException ex) {
    return ResponseEntity.badRequest()
        .body(
            TeamResponse.builder()
  ...
  public ResponseEntity<TeamResponse> handleUserAlreadyRegisteredForAnotherTeamException(
      UserAlreadyRegisteredForAnotherTeamException ex) {
    return ResponseEntity.badRequest()
        .body(
            TeamResponse.builder()
