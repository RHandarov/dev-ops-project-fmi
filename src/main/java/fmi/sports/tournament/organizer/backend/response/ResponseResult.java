...
public enum ResponseResult {
    ...
    NOT_EXISTING_USER,
    WRONG_PASSWORD,
    INVALID_REQUEST_DATA, VALID_TOKEN, USER_ALREADY_REGISTERED_FOR_TEAM, USER_NOT_IN_TEAM, SUCCESSFULLY_REMOVED_FROM_TEAM, USER_ALREADY_REGISTERED_FOR_ANOTHER_TEAM, SUCCESSFULLY_SIGNED_IN
}
