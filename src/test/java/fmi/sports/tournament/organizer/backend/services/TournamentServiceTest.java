...
class TournamentServiceTest {
  @Mock private TournamentsRepository tournamentsRepository;
  ...
  void getTournament_NotFound() {
    ...
    assertThrows(
        NoTournamentWithSuchIdException.class, () -> tournamentService.getById(tournamentId));
  }
}
